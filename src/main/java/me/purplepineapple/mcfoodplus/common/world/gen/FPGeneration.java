        ...
        if (!(biome.getCategory() == Biome.Category.NETHER) || !(biome.getCategory() == Biome.Category.THEEND)) {
            ...
            biome.getGeneration()
                    .addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.RANDOM_PATCH
                        .configured(FPFeatures.BLUEBERRY_BUSH_CONFIG).decorated(Features.Placements.HEIGHTMAP_DOUBLE).count(3))
                    .addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.RANDOM_PATCH
                            .configured(FPFeatures.STRAWBERRY_BUSH_CONFIG).decorated(Features.Placements.HEIGHTMAP_DOUBLE).count(5));
            }
        }
